        ...
        <div className="w-full max-w-md bg-white rounded-lg shadow p-8 space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="flex gap-2">
              <input className="w-1/2 border border-gray-300 rounded-md px-3 py-2 text-sm" name="name" placeholder="First name*" value={form.name} onChange={handleChange} required />
              <input className="w-1/2 border border-gray-300 rounded-md px-3 py-2 text-sm" name="lastname" placeholder="Last name*" value={form.lastname} onChange={handleChange} required />
            </div>

            <input className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm" name="company" placeholder="Company (optional)" value={form.company} onChange={handleChange} />

            <input className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm" type="email" name="email" placeholder="Email*" value={form.email} onChange={handleChange} required />
            ...
            <div className="relative">
              <input
                ...
                required
              />
              <button type="button" onClick={togglePassword} className="absolute right-3 top-2.5 text-gray-500">
            ...
            <div className="relative">
              <input
                ...
                required
              />
              <button type="button" onClick={toggleConfirm} className="absolute right-3 top-2.5 text-gray-500">
